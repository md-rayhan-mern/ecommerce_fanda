...
const Home = () => {
  ...
  const categories = [
    {
      ...
      name: "Power Sanders",
      image:
        "https://images.unsplash.com/photo-1564466809058-bf4114d55352?q=80&w=686&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
    {
      id: 2,
      name: "Other Projector Accessories",
      image:
        "https://plus.unsplash.com/premium_photo-1719289799337-9cb436447965?q=80&w=880&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      name: "Womens Fashion",
      image:
        "https://plus.unsplash.com/premium_photo-1675896084254-dcb626387e1e?q=80&w=935&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
    {
      id: 5,
    ...
    },
    {
      ...
      name: "Goat",
      image:
        "https://plus.unsplash.com/premium_photo-1677541205130-51e60e937318?q=80&w=1228&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
    {
      id: 7,
      name: "Watches and Accessories",
      image:
        "https://images.unsplash.com/photo-1549049950-48d5887197a0?q=80&w=764&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
    {
      id: 8,
    ...
    },
    {
      ...
      image:
        "https://media.istockphoto.com/id/1222813817/photo/elegant-wrist-watch-closeup-on-dark.webp?a=1&b=1&s=612x612&w=0&k=20&c=GWpoTrNApZ7bWd8QrMWbXNw4qdunk8AHPthPKkjpptc=",
    },
    {
      id: 14,
      name: "Eye Primers",
      image:
        "https://plus.unsplash.com/premium_photo-1677526496597-aa0f49053ce2?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
    {
      id: 15,
      name: "Digital Downloads",
      image:
        "https://plus.unsplash.com/premium_photo-1723708939980-55adb9dd0fc9?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDZ8fHxlbnwwfHx8fHw%3D",
    },
    {
      id: 16,
      name: "Traditional Laptops",
      image:
        "https://plus.unsplash.com/premium_photo-1663089525424-ca57c1a28a08?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
  ];
  //Products
  const products = [
  ...
  return (
    ...
    <motion.div
      ...
      initial="hidden"
      animate="visible"
      className="w-full min-h-screen bg-neutral-900 pb-12"
    >
