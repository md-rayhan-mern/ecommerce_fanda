...
const ProductCard = ({
  ...
  return (
    ...
    >
      ...
      <button
        onClick={handleCart}
        className="absolute top-3 right-3 z-10 p-2 bg-white/90 hover:bg-white text-gray-500 hover:text-red-500 rounded-full transition-all duration-200 shadow-sm border border-gray-50 active:scale-90"
      >
