  ...
  return (
    <div className="w-full max-w-[1500px] mx-auto p-4 md:p-6 bg-white font-sans text-sm text-gray-800">
      ...
      <form
        ...
        className="flex flex-col sm:flex-row gap-0 items-stretch border border-gray-200 rounded overflow-hidden focus-within:border-orange-500 transition-all mb-6"
      >
        <input
          type="text"
          value={newQuestion}
      ...
      {/* Question list */}
      {questions.length === 0 ? (
        <div className="w-full max-w-4xl mx-auto flex flex-col items-center justify-center py-16 bg-white font-sans text-center px-4">
